...
profit.append(settle[-1] * industry_action[0][0] - industry_temp[0][0] * raw_material_price - industry_state[0][1] *
              industry_state[0][6])
post_profit.append([0])
for i in range(0, len(post_profit)):
    profit[i] = profit[i] + post_profit[i]
